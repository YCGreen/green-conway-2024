...
public class RleParserTest {
    ...
    public void parseBlinker() {
        ...
        int[][] gridArr = parser.parse("#N Blinker\n"
                + "#O John Conway\n"
    ...
    public void parseSwitch() {
        RleParser parser = new RleParser();
        int[][] gridArr = parser.parse("#N Switch engine\n"
                + "#O Charles Corderman\n"
    ...
    public void parseGlider() {
        RleParser parser = new RleParser();
        int[][] gridArr = parser.parse("#C This is a glider.\n"
                + "x = 3, y = 3\n"
                + "bo$2bo$3o!");
    ...
    public void parsePi() {
        RleParser parser = new RleParser();
        int[][] gridArr = parser.parse("#N Pi-heptomino\n"
